...
export default function AuthChoice() {
  ...
  return (
    <div className="app-screen min-h-screen bg-linear-to-br from-sky-100 via-white to-cyan-100 px-6 py-16 sm:px-8 lg:px-10">
      <div className="mx-auto flex max-w-5xl flex-col items-center text-center px-2 sm:px-4">
        ...
        <div className="grid w-full gap-4 sm:gap-6 grid-cols-2">
          ...
          >
            <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-sky-500 to-cyan-400 text-3xl text-white shadow-lg">
              ✨
            </div>
            ...
            <span className="inline-flex items-center rounded-full bg-sky-500 px-4 py-2 text-sm font-semibold text-white transition group-hover:bg-sky-600">
              {t("signup.button")} →
            </span>
          </Link>
        ...
        <Link
          to="/"
          className="mt-8 text-sm font-semibold text-slate-700 underline decoration-sky-400 underline-offset-4"
        >
          {t("auth.backHome")}
        </Link>
      </div>
