...
export const translations: Record<AppLanguage, Record<string, string>> = {
  "en-basic": {
    ...
    "messages.spamTitle": "Spam Messages",
    "messages.spamSubtitle": "Messages from people you do not follow back.",
    "messages.spamEmpty": "No spam messages yet.",
    "messages.archive": "Archived",
    "messages.archiveTitle": "Archived Messages",
    "messages.archiveSubtitle": "Your archived conversations are stored here.",
    "messages.archiveLoading": "Loading archived messages...",
    "messages.archiveEmpty": "No archived messages yet.",
    "messages.archiveBack": "Back",
  ...
  "fr-fr": {
    ...
    "messages.spamTitle": "Messages indésirables",
    "messages.spamSubtitle": "Messages de personnes que vous ne suivez pas en retour.",
    "messages.spamEmpty": "Aucun message indésirable pour le moment.",
    "messages.archive": "Archivés",
    "messages.archiveTitle": "Messages archivés",
    "messages.archiveSubtitle": "Vos conversations archivées sont stockées ici.",
    "messages.archiveLoading": "Chargement des messages archivés...",
    "messages.archiveEmpty": "Aucun message archivé pour le moment.",
    "messages.archiveBack": "Retour",
    "notifications.title": "Notifications",
